# STAT 386 — Course Website

A Quarto-based website hosting lecture slides and in-class code demos for **STAT 386: Data Science Process** (Fall 2026). The syllabus, assignments, and resources live in the Canvas course; this site is dedicated to materials used during class sessions.
...
├── index.qmd            # Home page (links to slides and demos)
...
4. Add `slides/week-02.qmd` to the sidebar in `_quarto.yml` under the "Slides" section.
5. Run `quarto render`.
...
5. Add `demos/week-02.qmd` to the sidebar in `_quarto.yml` under the "Demos" section.
6. Run `quarto render`.
